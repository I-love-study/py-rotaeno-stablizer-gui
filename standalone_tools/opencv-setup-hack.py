...
def main():
    ...
    build_contrib = 0 #get_build_env_var_by_name("contrib")
    build_headless = 1 # get_build_env_var_by_name("headless")
    ...
    cmake_args = (
        ...
        + [
            ...
            # "-DBUILD_opencv_imgcodecs=OFF", 因为 background 来源类型多种多样，所以不能去除
